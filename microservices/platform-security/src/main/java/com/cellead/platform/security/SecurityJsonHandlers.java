...
public final class SecurityJsonHandlers {
    ...
    public static void configure(
            ExceptionHandlingConfigurer<org.springframework.security.config.annotation.web.builders.HttpSecurity> handling,
            ObjectMapper mapper
    ) {
    ...
    private static void write(HttpServletResponse response, ObjectMapper mapper, int status, String code, String message)
            throws IOException {
